...
function [fpr_final,tpr_final, score_final] = Find_Borji_ROC_Curve_General_For_DeepFeat(LayerType,MapType)
...
% 
  ...
  strng_2 = sprintf('C:/Users/neoaa/OneDrive/Desktop/Aashish_Research/Saliency_Maps_DeepFeat/ResNet50_Maps/%s/%s/%d.jpg',LayerType, MapType,m);
